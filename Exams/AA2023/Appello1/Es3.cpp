...
int main()
{
    ...
    (p2->j())->g(); cout << endl;
    cout <<"6:"; cout << endl; //B() C() D() E() F()
    C* p=new F(F()); cout << endl; 
    cout <<"7:"; cout << endl;  //(p1->j())->k(); cout << endl; non compila const
    cout <<"non compila"; cout << endl;
    cout <<"8:"; cout << endl;
    //(dynamic_cast<const F*>(p1->j()))->g();cout << endl; // stampa E::j e poi dà errore, dovuto al const
